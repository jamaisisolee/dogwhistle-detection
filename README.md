...
> End-to-end NLP pipeline for detecting coded dog-whistle language on Reddit, classifying ideological ingroups, and generating structured explanations using RoBERTa and Flan-T5-XL + LoRA.
